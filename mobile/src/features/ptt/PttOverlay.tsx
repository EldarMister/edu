...
export function PttOverlay() {
  ...
  return (
    <View pointerEvents="box-none" style={StyleSheet.absoluteFill}>
      ...
      >
        <PwaIcon name="radio" size={37} color={colors.white} strokeWidth={2.1} />
      ...
      >
        <View style={styles.header}>
          ...
          <FastPressable onPress={() => setOpen(false)} hitSlop={12} style={styles.closeBtn}>
            <PwaIcon name="close" size={29} color={colors.textMuted} strokeWidth={2} />
          </FastPressable>
        </View>
        ...
        <View style={styles.channelCard}>
          <View style={styles.channelIcon}>
            <PwaIcon name="radio" size={34} color={colors.primary} strokeWidth={2.1} />
          </View>
        ...
        <View style={styles.actions}>
          ...
          >
            <PwaIcon name="radio" size={33} color={colors.white} strokeWidth={2.1} />
            <Text style={styles.talkText} numberOfLines={1}>Зажмите для разговора</Text>
          </FastPressable>
          <FastPressable onPress={disableRadio} style={styles.powerButton}>
            <PwaIcon name="power" size={19} color={colors.textSecondary} strokeWidth={2.2} />
