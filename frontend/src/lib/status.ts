...
export const TABLE_STATUS: Record<TableStatus, StatusMeta> = {
  ...
  occupied: { label: 'Открыт', badge: 'bg-primary/10 text-primary', dot: 'bg-primary' },
  ...
  ready: { label: 'Готов', badge: 'bg-success/10 text-success', dot: 'bg-success' },
  served: { label: 'Подан', badge: 'bg-primary/10 text-primary', dot: 'bg-primary' },
